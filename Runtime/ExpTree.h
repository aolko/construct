...
public:
	...
	int index;			// Index to variable
	CRunObjType* pOwnerType;	// Type of the owner, 
...
public:
	...
	int numParams;
	ExpPart** paramsEnd;
	ExpPart* parameters[CRUNTIME_MAX_PARAMS];
