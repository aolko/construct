...
#else
#pragma comment("Warning: compiler or settings not compatible with Construct Runtime ABI. Enabling workaround functions. See SDK docs on 'Runtime ABI'.")
#endif

#pragma warning(disable: 4786)	// debug info truncated 255 chars
