...
BEGIN_PROPERTY_TABLE();
	...
	PROPERTY_VALUE(maxPoints, "Number of points", "The number of points that the ribbon distributes across.");
	PROPERTY_VALUE(width, "Thickness", "The thickness in pixels of the ribbon");
	PROPERTY_VALUE(columns, "Segments", "The number of segments that make up the ribbon. This should be the same as the number of distortion columns in your sprite");
