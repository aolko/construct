...
#include "..\..\Common\CommonAceDecl.hpp"
	...
	long aDoString(LPVAL params);

	long eGetGlobalValue(LPVAL params, ExpReturn& ret);
	long eGetGlobalString(LPVAL params, ExpReturn& ret);
	long eGetParamValue(LPVAL params, ExpReturn& ret);
	long eGetParamString(LPVAL params, ExpReturn& ret);
	void performTrigger();
