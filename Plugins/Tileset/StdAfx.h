...
class CMapPoint : public CPoint
{
public:
	CMapPoint(int initX, int initY)
	{
		x = initX;
		y = initY;
	}
	...
	bool operator == (const CMapPoint& point)
	{
...
{
public:
	bool operator()(const CMapPoint& point1,const CMapPoint& point2) const
	{
