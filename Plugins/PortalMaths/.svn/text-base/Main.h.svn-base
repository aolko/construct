...
#include "..\..\Common\CommonAceDecl.hpp"
	...
	long aPortalSettings(LPVAL params);
	long aObjectSettings(LPVAL params);
	long aTargetPortal(LPVAL params);

	long eProjectedSpeedX(LPVAL params, ExpReturn& ret);
	long eProjectedSpeedY(LPVAL params, ExpReturn& ret);
	long eProjectedX(LPVAL params, ExpReturn& ret);
	long eProjectedY(LPVAL params, ExpReturn& ret);
	long eProjectedAngle(LPVAL params, ExpReturn& ret);

	///////////////////////////////////////////////

	cr::point projectSpeed();
	cr::point projectPosition();

	cr::point objectPosition;
	cr::point objectSpeed;
	float objectAngle;
