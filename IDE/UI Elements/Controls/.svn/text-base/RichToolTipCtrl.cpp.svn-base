...
#endif // _AFXDLL
#pragma warning (disable : 4706)  // assignment within condition expression - used in multimon.h


#ifndef TTM_ADJUSTRECT
#define TTM_ADJUSTRECT          (WM_USER + 31)
#endif // TTM_ADJUSTRECT
...
BEGIN_MESSAGE_MAP(CRichToolTipCtrl::CRichToolTipRichEditCtrl, CRichEditCtrl)
	//{{AFX_MSG_MAP(CRichToolTipRichEditCtrl)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
CSize CRichToolTipCtrl::CalculateMinimiumRichEditSize()
{
  ...
  // show the rich-edit control, as RequestResize 
  // doesn't work on Win98 (and possibly others?) if it is hidden
  ...
  // now hide the edit control again
