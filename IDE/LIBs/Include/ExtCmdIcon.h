...
/////////////////////////////////////////////////////////////////////////////
// CExtCmdIconOld
// old command icon class
/*
class __PROF_UIS_API CExtCmdIconOld
{
public:
	enum e_draw_type_t
	{
...
private:
	...
	public:
		BitmapCache(
			...
			bool bCloneBitmap = true // if false - pRectBitmapSrc must be NULL
			);
...
public:
	...
	static bool g_bAllowAlphaIconsOnWinXPorLater;
	static double g_fDisabledAlphaFactor;
	static double g_fDisabledBrightnessFactor;
	...
	CExtCmdIconOld( const CExtCmdIconOld & other );
	virtual ~CExtCmdIconOld();
	virtual bool IsEmpty() const;
	virtual void Empty();
	virtual void Serialize( CArchive & ar );
	virtual void AssignFromOther( const CExtCmdIconOld & other );
	...
	CExtCmdIconOld & operator = ( const CExtCmdIconOld & other );
	...
	bool AlphaIconCache_GenerateForWinXP(
		double fDisabledAlphaFactor,
		double fDisabledBrightnessFactor
		) const;
	bool AlphaIconCache_GenerateEmulation() const;
	...
	virtual bool CreateScaledCopy(
		const CExtCmdIconOld & other,
		CSize newSize,
		COLORREF clrForceTransparent = COLORREF(-1L)
		);
