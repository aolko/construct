...
#define __PROF_UIS_VERSION_DWORD    DWORD( 0x02080400 )
#define __PROF_UIS_VERSION                 0x02080400
...
// Prof-UIS basic library
			...
			#if (defined _DEBUG)
				#if (defined _UNICODE)
					#define __PROF_UIS_LIB_NAME		   "ProfUIS284yud-RDE.lib"
				#elif (defined _MBCS)
					#define __PROF_UIS_LIB_NAME		   "ProfUIS284ymd-RDE.lib"
				#else
					#define __PROF_UIS_LIB_NAME		   "ProfUIS284ynd-RDE.lib"
				#endif // _UNICODE
			#else
				#if (defined _UNICODE)
					#define __PROF_UIS_LIB_NAME		   "ProfUIS284yu-RDE.lib"
				#elif (defined _MBCS)
					#define __PROF_UIS_LIB_NAME		   "ProfUIS284ym-RDE.lib"
				#else
					#define __PROF_UIS_LIB_NAME		   "ProfUIS284yn-RDE.lib"
				#endif // _UNICODE
			#endif // _DEBUG
		#else
			...
			#if (defined _DEBUG)
				#if (defined _UNICODE)
					#define __PROF_UIS_LIB_NAME		   "ProfUIS284yud.lib"
				#elif (defined _MBCS)
					#define __PROF_UIS_LIB_NAME		   "ProfUIS284ymd.lib"
				#else
					#define __PROF_UIS_LIB_NAME		   "ProfUIS284ynd.lib"
				#endif // _UNICODE
			#else
				#if (defined _UNICODE)
					#define __PROF_UIS_LIB_NAME		   "ProfUIS284yu.lib"
				#elif (defined _MBCS)
					#define __PROF_UIS_LIB_NAME		   "ProfUIS284ym.lib"
				#else
					#define __PROF_UIS_LIB_NAME		   "ProfUIS284yn.lib"
				#endif // _UNICODE
			#endif // _DEBUG
		...
		#define __PROF_UIS_STATE_MANAGER_DECL _declspec(dllimport)
			...
			#if (defined _DEBUG)
				#if (defined _UNICODE)
					#define __PROF_UIS_MODULE_NAME	_T("ProfUIS284ud-RDE.dll")
					#define __PROF_UIS_LIB_NAME		   "ProfUIS284ud-RDE.lib"
				#elif (defined _MBCS)
					#define __PROF_UIS_MODULE_NAME	_T("ProfUIS284md-RDE.dll")
					#define __PROF_UIS_LIB_NAME		   "ProfUIS284md-RDE.lib"
				#else
					#define __PROF_UIS_MODULE_NAME	_T("ProfUIS284nd-RDE.dll")
					#define __PROF_UIS_LIB_NAME		   "ProfUIS284nd-RDE.lib"
				#endif // _UNICODE
			#else
				#if (defined _UNICODE)
					#define __PROF_UIS_MODULE_NAME	_T("ProfUIS284u-RDE.dll")
					#define __PROF_UIS_LIB_NAME		   "ProfUIS284u-RDE.lib"
				#elif (defined _MBCS)
					#define __PROF_UIS_MODULE_NAME	_T("ProfUIS284m-RDE.dll")
					#define __PROF_UIS_LIB_NAME		   "ProfUIS284m-RDE.lib"
				#else
					#define __PROF_UIS_MODULE_NAME	_T("ProfUIS284n-RDE.dll")
					#define __PROF_UIS_LIB_NAME		   "ProfUIS284n-RDE.lib"
				#endif // _UNICODE
			#endif // _DEBUG
		#else
			#if (defined _DEBUG)
				#if (defined _UNICODE)
					#define __PROF_UIS_MODULE_NAME	_T("ProfUIS284ud.dll")
					#define __PROF_UIS_LIB_NAME		   "ProfUIS284ud.lib"
				#elif (defined _MBCS)
					#define __PROF_UIS_MODULE_NAME	_T("ProfUIS284md.dll")
					#define __PROF_UIS_LIB_NAME		   "ProfUIS284md.lib"
				#else
					#define __PROF_UIS_MODULE_NAME	_T("ProfUIS284nd.dll")
					#define __PROF_UIS_LIB_NAME		   "ProfUIS284nd.lib"
				#endif // _UNICODE
			#else
				#if (defined _UNICODE)
					#define __PROF_UIS_MODULE_NAME	_T("ProfUIS284u.dll")
					#define __PROF_UIS_LIB_NAME		   "ProfUIS284u.lib"
				#elif (defined _MBCS)
					#define __PROF_UIS_MODULE_NAME	_T("ProfUIS284m.dll")
					#define __PROF_UIS_LIB_NAME		   "ProfUIS284m.lib"
				#else
					#define __PROF_UIS_MODULE_NAME	_T("ProfUIS284n.dll")
					#define __PROF_UIS_LIB_NAME		   "ProfUIS284n.lib"
				#endif // _UNICODE
			#endif // _DEBUG
		#endif // else from (defined __PROF_UIS_FOR_REGULAR_DLL)
			...
			#if (defined _DEBUG)
				#if (defined _UNICODE)
					#define __PROF_UIS_LIB_NAME		   "ProfUIS284sud-RDE.lib"
				#elif (defined _MBCS)
					#define __PROF_UIS_LIB_NAME		   "ProfUIS284smd-RDE.lib"
				#else
					#define __PROF_UIS_LIB_NAME		   "ProfUIS284snd-RDE.lib"
				#endif // _UNICODE
			#else
				#if (defined _UNICODE)
					#define __PROF_UIS_LIB_NAME		   "ProfUIS284su-RDE.lib"
				#elif (defined _MBCS)
					#define __PROF_UIS_LIB_NAME		   "ProfUIS284sm-RDE.lib"
				#else
					#define __PROF_UIS_LIB_NAME		   "ProfUIS284sn-RDE.lib"
				#endif // _UNICODE
			#endif // _DEBUG
		#else
			#define __PROF_UIS_MANAGE_STATE AFX_MANAGE_STATE( ::AfxGetAppModuleState() )
			#if (defined _DEBUG)
				#if (defined _UNICODE)
					#define __PROF_UIS_LIB_NAME		   "ProfUIS284sud.lib"
				#elif (defined _MBCS)
					#define __PROF_UIS_LIB_NAME		   "ProfUIS284smd.lib"
				#else
					#define __PROF_UIS_LIB_NAME		   "ProfUIS284snd.lib"
				#endif // _UNICODE
			#else
				#if (defined _UNICODE)
					#define __PROF_UIS_LIB_NAME		   "ProfUIS284su.lib"
				#elif (defined _MBCS)
					#define __PROF_UIS_LIB_NAME		   "ProfUIS284sm.lib"
				#else
					#define __PROF_UIS_LIB_NAME		   "ProfUIS284sn.lib"
				#endif // _UNICODE
			#endif // _DEBUG
		#endif // else from (defined __PROF_UIS_FOR_REGULAR_DLL)
#endif // _AFXDLL
