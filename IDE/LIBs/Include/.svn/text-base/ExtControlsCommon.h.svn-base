...
public:
	...
	virtual void OnHeaderItemClick( INT nColNo );
...
public:
	...
	EXTENDED_ITEM_DATA & ExtendedItemDataGet( INT nColNo );
	INT HeaderItemExtentGet( INT nColNo ) const;
	void HeaderItemExtentSet(
		INT nColNo,
		INT nExtent,
		bool bRedraw = true
		);
...
public:
	...
	void ColumnStateSave( CExtSafeString strSection, CExtSafeString strControl );
...
public:
	...
	{
	public:
		bool m_bEditingLabel:1, m_bResultSaved:1;
