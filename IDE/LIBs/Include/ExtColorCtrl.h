...
public:
	...
	static CExtSafeString GetColorModeName( e_mode_t eMode );

	DECLARE_DYNCREATE( CExtColorCtrl );
	DECLARE_CExtPmBridge_MEMBERS( CExtColorCtrl );
...
__PROF_UIS_API void AFXAPI __EXT_MFC_DDX_ColorCtrl( CDataExchange * pDX, INT nIDC, COLORREF & value );
